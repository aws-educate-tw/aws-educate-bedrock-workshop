...
export const mockPlayResponse: PlayResponse = {
  ...
  eventText:
    "今天是你第一天上學，你看到教室裡有很多新同學。有個同學看起來很害羞，獨自坐在角落。另一邊有一群同學在熱烈討論著什麼。你會怎麼做？",
...
export const mockSummaryState: SummaryState = {
  ...
  finalSummaryText:
    "你度過了充實而有意義的一生。從小就展現出的善良和智慧，讓你在人生的各個階段都能做出正確的選擇。你重視人際關係，也不忘記持續學習和成長。雖然在財富積累上不是最突出的，但你擁有的友誼和家庭溫暖是無價的。你的人生證明了，真正的成功不只是金錢，更是內心的富足和對他人的正面影響。",
  achievements: [
    {
      title: "終身學習者",
      desc: "持續學習新知識，從不停止成長",
  ...
  finalImageUrl:
    "https://via.placeholder.com/300x400/f0f0f0/333333?text=人生終章",
};
...
export const getStageEvent = (stage: string) => {
  const events = {
    childhood: {
      ...
      eventText:
        "今天是你第一天上學，教室裡有很多新同學。有個同學看起來很害羞，獨自坐在角落。另一邊有一群同學在熱烈討論。你會怎麼做？",
      optionA: "主動去和害羞的同學聊天",
      optionB: "加入熱烈討論的同學群",
    },
    student: {
      ...
      eventText:
        "高三了，你需要選擇大學科系。父母希望你選擇穩定的商科，但你對藝術很有興趣。朋友們都在討論未來規劃。",
      optionA: "聽從父母建議選擇商科",
      optionB: "追隨內心選擇藝術系",
    },
    adult: {
      ...
      eventText:
        "你在公司工作了幾年，現在有機會升職到管理層，但需要更多時間投入工作。同時，你也想多陪伴家人。",
      optionA: "接受升職，專注事業發展",
      optionB: "維持現狀，重視家庭時光",
    },
    elder: {
      ...
      eventText:
        "退休後的你有很多時間，可以做一直想做但沒時間做的事。你想要如何度過這段黃金歲月？",
      optionA: "投入志願服務，回饋社會",
      optionB: "專注個人興趣，享受生活",
    },
  };
